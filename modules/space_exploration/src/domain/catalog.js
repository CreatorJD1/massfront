...
export const MODULE_CATALOG = deepFreeze({
  command_holotable: { id: 'command_holotable', name: 'Strategic Holography Vault', powerDrawMW: 5, cost: { components: 90, credits: 1200 }, effects: { casualtyForecast: 1 } },
  command_archive: { id: 'command_archive', name: 'Continuity Archive', powerDrawMW: 5, cost: { components: 70, researchPoints: 80 }, effects: { commanderXpPct: 10 } },
  command_terminal: { id: 'command_terminal', name: 'Classic Modes Terminal', powerDrawMW: 5, cost: { components: 55, credits: 900 }, effects: { commanderXpPct: 10 } },
  route_predictor: { id: 'route_predictor', name: 'Autopilot Route Predictor', powerDrawMW: 9, cost: { components: 75, researchPoints: 60 }, effects: { transitFuelPct: -5 } },
  orbit_scheduler: { id: 'orbit_scheduler', name: 'Orbital Approach Scheduler', powerDrawMW: 7, cost: { components: 60, credits: 700 }, effects: { transitOldestWork: 1 } },
  transit_archive: { id: 'transit_archive', name: 'Transit Hazard Archive', powerDrawMW: 6, cost: { components: 55, researchPoints: 45 }, effects: { transitFuelPct: -5 } },
  spectral_array: { id: 'spectral_array', name: 'Deep Spectral Array', powerDrawMW: 10, cost: { components: 85, alloys: 45 }, effects: { surveyIntelligenceBonus: 1 } },
  probe_telemetry: { id: 'probe_telemetry', name: 'Probe Telemetry Lattice', powerDrawMW: 8, cost: { components: 70, credits: 650 }, effects: { surveyProbeDiscount: 1 } },
  anomaly_filter: { id: 'anomaly_filter', name: 'Anomaly Discrimination Core', powerDrawMW: 12, cost: { components: 110, researchPoints: 120 }, effects: { surveyResearchRewardPct: 10 } },
  operation_table: { id: 'operation_table', name: 'Mission Operations Table', powerDrawMW: 8, cost: { components: 65, credits: 800 }, effects: { operationModSlots: 1 } },
  readiness_net: { id: 'readiness_net', name: 'Strike Readiness Network', powerDrawMW: 10, cost: { components: 85, researchPoints: 75 }, effects: { deploymentSlots: 1 } },
  debrief_archive: { id: 'debrief_archive', name: 'Ground Debrief Archive', powerDrawMW: 6, cost: { components: 55, credits: 650 }, effects: { commanderXpPct: 15, operationResearchRewardPct: 5 } },
  xenology_suite: { id: 'xenology_suite', name: 'Xenology Suite', powerDrawMW: 10, cost: { components: 75, bioSamples: 20 }, effects: { bioRewardPct: 10 } },
  gravitic_lab: { id: 'gravitic_lab', name: 'Gravitic Materials Lab', powerDrawMW: 14, cost: { components: 95, researchPoints: 90 }, effects: { researchProgressPct: 10 } },
  containment_lab: { id: 'containment_lab', name: 'Brood Containment Lab', powerDrawMW: 16, cost: { components: 120, bioSamples: 35 }, effects: { bioResearchCostPct: -10 } },
  precision_forge: { id: 'precision_forge', name: 'Precision Component Forge', powerDrawMW: 15, cost: { alloys: 80, components: 45 }, effects: { constructionMaterialCostPct: -8 } },
  probe_foundry: { id: 'probe_foundry', name: 'Autonomous Probe Foundry', powerDrawMW: 18, cost: { alloys: 65, components: 70 }, effects: { victoryProbeRestore: 1 } },
  repair_fabricator: { id: 'repair_fabricator', name: 'Field Repair Fabricator', powerDrawMW: 12, cost: { alloys: 90, credits: 850 }, effects: { retrofitSalvagePct: 20 } },
  drive_tuner: { id: 'drive_tuner', name: 'Fold-Drive Harmonic Tuner', powerDrawMW: 12, cost: { components: 105, researchPoints: 70 }, effects: { transitFuelPct: -6 } },
  reactor_baffles: { id: 'reactor_baffles', name: 'Reactor Flux Baffles', powerGenerationBonusMW: 35, cost: { alloys: 100, components: 65 }, effects: { constructionPowerPerSlotMW: 1 } },
  thermal_reclaimer: { id: 'thermal_reclaimer', name: 'Thermal Energy Reclaimer', powerGenerationBonusMW: 25, cost: { alloys: 75, credits: 750 }, effects: { constructionPowerPerSlotMW: 2 } },
  trauma_bay: { id: 'trauma_bay', name: 'Expedition Trauma Bay', powerDrawMW: 8, cost: { components: 80, bioSamples: 25 }, effects: { injurySeverityBands: -1 } },
  habitation_arcology: { id: 'habitation_arcology', name: 'Habitation Arcology', powerDrawMW: 10, cost: { alloys: 95, credits: 1000 }, effects: { districtWorkEverySecondCycle: 1 } },
  recovery_ward: { id: 'recovery_ward', name: 'Neural Recovery Ward', powerDrawMW: 12, cost: { components: 100, bioSamples: 30 }, effects: { personnelRecoveryCycles: -1, commanderXpPct: 10 } },
  nova_quarters: { id: 'nova_quarters', name: 'Nova Resident Enclave', powerDrawMW: 6, cost: { alloys: 55, credits: 750 }, effects: { factionReputationPct: 8 } },
  dominion_quarters: { id: 'dominion_quarters', name: 'Dominion Resident Enclave', powerDrawMW: 8, cost: { alloys: 70, credits: 850 }, effects: { factionReputationPct: 8 } },
  syndicate_quarters: { id: 'syndicate_quarters', name: 'Syndicate Resident Enclave', powerDrawMW: 7, cost: { alloys: 60, credits: 900 }, effects: { factionLoyaltyPct: 8 } },
  dropship_racks: { id: 'dropship_racks', name: 'Dropship Service Racks', powerDrawMW: 12, cost: { alloys: 90, components: 60 }, effects: { deploymentSlots: 1 } },
  medevac_cradle: { id: 'medevac_cradle', name: 'Medevac Launch Cradle', powerDrawMW: 10, cost: { components: 90, bioSamples: 20 }, effects: { personnelRecoveryCycles: -1 } },
  support_bay: { id: 'support_bay', name: 'Operational Support Bay', powerDrawMW: 14, cost: { alloys: 80, components: 85 }, effects: { operationModSlots: 1 } },
  cryo_cargo: { id: 'cryo_cargo', name: 'Cryogenic Sample Hold', powerDrawMW: 8, cost: { alloys: 60, components: 55 }, effects: { bioRewardPct: 10 } },
  probe_magazine: { id: 'probe_magazine', name: 'Probe Magazine', powerDrawMW: 6, cost: { alloys: 65, credits: 650 }, effects: { victoryProbeRestore: 1 } },
  fuel_bladders: { id: 'fuel_bladders', name: 'Armored Fuel Bladders', powerDrawMW: 4, cost: { alloys: 90, components: 50 }, effects: { victoryFuelRestore: 2 } }
});
