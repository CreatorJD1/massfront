...
(function(){
  ...
  window.addEventListener('load',function(){
    navigator.serviceWorker.register('./sw.js?v=1.33.85-shell1',{scope:'./',updateViaCache:'none'})
      .then(function(reg){
