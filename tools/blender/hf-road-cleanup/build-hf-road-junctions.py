...
# The junction blend consumes the straight's reviewed review-GLB and pins it
# by hash, so the junction can never be built against a straight nobody
# looked at. Repinned 2026-08-28: the straight was rebuilt to give its
# production meshes UV layers and hard-surface shading, which is a required
# repair, so the pin has to track it. Both kits remain
# runtimeAccepted: false / visualAccepted: false pending human review --
# repinning tracks the source, it does not accept it.
STRAIGHT_SHA256 = "21905B1C35A3F7C13FEBC390067FE9C08A51518413BCAC4CBD851A109C8B1779"
GRID_M = 40.0
HALF_GRID_M = 20.0
