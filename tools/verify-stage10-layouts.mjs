...
const commands=[
  ...
  ['repaired-model-pack','node',['tools/verify-stage10-repaired-model-pack.mjs']]
];
const results=[];
...
const report={schema:'Stage10LayoutAggregateVerificationV5',generatedAt:new Date().toISOString(),
